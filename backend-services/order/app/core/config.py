...
AUTHORIZATION_SERVER_CUSTOMER_ENDPOINT = "/Authentication/customer-policy"
AUTHORIZATION_SERVER_VENDOR_ENDPOINT = "/Authentication/vendor-policy"
AUTHORIZATION_SERVER_ADMIN_ENDPOINT = "/Authentication/admin-policy"
